function [p, V, E, gnorm, Y_hat] = GR_linerr_spd(X, Y, varargin)
...
% This is for symmetric positive matrices.
    ...
    p = Y(:,:,1); % Karcher mean can be good option for fast convergence
    ...
    for niter=1:maxiter
        ...
        for i = 1:50
            ...
            E_new = fevalGR_mv_spd(p_new, V_new, X, Y);
